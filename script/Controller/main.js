(function() {
	'use strict';
	angular.module('myApp.main', ['ngRoute','app.configEnv'])
...
angular.module('myApp.main').controller('MainCtrl', ['$rootScope','$scope','parallaxHelper','$http','$localStorage','searchService','$window','CONFIG','jwtHelper',
	function($rootScope,$scope,parallaxHelper,$http,$localStorage,searchService,$window,CONFIG,jwtHelper) {
